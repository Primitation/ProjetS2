    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
{
    ...
    // Check if the camera's culling mask includes the "NoPost" layer
    bool excludeFromPostProcessing = (renderingData.cameraData.camera.cullingMask & (1 << LayerMask.NameToLayer("NoPost"))) != 0;

    if (!excludeFromPostProcessing)
    {
    ...
    {
        // If the object is in the "NoPost" layer, render it directly to the destination texture
